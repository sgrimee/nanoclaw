...
// Auth secrets that must never leak into process.env (visible to Bash subprocesses).
// With the credential proxy these aren't in env-dir anymore, but guard anyway.
